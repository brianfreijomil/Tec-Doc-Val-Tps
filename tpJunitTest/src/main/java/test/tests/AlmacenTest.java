...
class AlmacenTest {
    ...
    static void  InitClass() {
        ...
        ingATestear.add( new Ingrediente("harina", "kg", 10, 5000));
        ingATestear.add(  new Ingrediente("aceilte", "ltd", 15, 4000));
        ingATestear.add(  new Ingrediente("papa", "kg", 170, 30000));
        ingATestear.add(  new Ingrediente("huevo", "un", 150, 3334));
        ingATestear.add( new Ingrediente("fideos", "kg", 10,1000));
    }
